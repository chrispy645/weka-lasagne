...
java -Xmx6g weka.Run .LasagneNet \
    ...
    -layer ".MaxPool2DLayer -pool_size_x 2 -pool_size_y 2" \
    -layer ".DenseLayer -num_units 10 -nonlinearity \"weka.lasagne.nonlinearities.Rectify \"" \
    -loss ".CategoricalCrossEntropy -l1 0.0 -l2 0.0" \
    -update ".Adagrad -learning_rate 0.1 -epsilon 1.0E-6" \
    -epochs 10 \
    -batch_iterator ".ImageBatchIterator -batch_size 128 -width 28 -height 28 -prefix \"/Users/cjb60/github/weka-lasagne/datasets/mnist-data\"" \
    -eval_size 0.1 \
